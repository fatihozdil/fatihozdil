	...
	<div class="container">
		...
		<div id="product-carousel" class="owl-carousel owl-theme">
			...
			while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)){ 
				$urunfotosor=$db->prepare("SELECT * FROM urunfoto where urun_id=:id order by urunfoto_sira asc limit 1");
				...
				<div class="item">
					...
					<div class="productwrap">
						<div class="pr-img">
							<div class="hot"></div>
							<a href="<?php echo "urun-".$uruncek['urun_seourl']."-".$uruncek['urun_id']; ?>"><img src="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" alt="" class="img-responsive"></a>
...
<div class="container">
	<div class="row">
		<div class="col-md-9"><!--Main content-->
			...
			<p class="ct">
				<?php $hakkimizdasor=$db->prepare("SELECT * FROM hakkimizda where hakkimizda_id=:id");
