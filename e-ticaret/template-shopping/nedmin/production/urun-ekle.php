          ...
          <div class="x_title">
            ...
            <div class="x_content">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input placeholder="ürün adı giriniz" type="text" name="urun_ad" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <!-- Ck Editör Başlangıç -->
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">          
                <textarea id="editor1"  name="urun_detay" placeholder="ürün detay giriniz"></textarea>
              </div>
            </div>
            <script>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input placeholder="ürün fiyat giriniz" type="text" name="urun_fiyat" id="first-name" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input placeholder="ürün video  giriniz" type="text" name="urun_video" id="first-name" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input placeholder="ürün keyword giriniz" type="text" name="urun_keyword" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input placeholder="ürün stok drumu giriniz" type="text" name="urun_stok" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
