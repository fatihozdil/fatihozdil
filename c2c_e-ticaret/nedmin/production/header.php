...
session_start();
 ...
 echo $_SESSION['userkullanici_id'];
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="kullanici.php"><i class="fa fa-user"></i> kullanıcılar</a></li>                
                 ...
                 <li><a href="menu.php"><i class="fa fa-bookmark"></i> menüler</a></li> 
                   <li><a href="urun.php"><i class="fa fa-shopping-basket"></i> ürünler</a></li>                   
                 <li><a href="kategori.php"><i class="fa fa-bookmark"></i> kategoriler</a></li>
                 <li><a href="yorum.php"><i class="fa fa-comment"></i> yorumlar</a></li>                 
                 <li><a href="banka.php"><i class="fa fa-bank"></i> banka işlemleri</a></li>                 
