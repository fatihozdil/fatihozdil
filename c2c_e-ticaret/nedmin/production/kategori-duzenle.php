            ...
            <form action="../netting/adminislem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="<?php echo$kategoricek['kategori_ad']  ?>" type="text" name="kategori_ad" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="<?php echo$kategoricek['kategori_sira']  ?>" type="text" name="kategori_sira" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
                 <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control" name="kategori_onecikar" required="">
                  <option value="1" <?php echo $kategoricek['kategori_onecikar']== '1' ? 'selected=""'  : ""
                  ; ?>>evet</option>
                  <option value="0" <?php echo $kategoricek['kategori_onecikar']== '0' ? 'selected=""'  : ""
                  ; ?>>hayır</option>
                </select>
