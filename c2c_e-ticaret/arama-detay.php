         ...
         // }
                                ...
                                if (isset($_POST['searchpage'])) {
                                   ...
                                   // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
                                        ...
                                        $urunsor=$db->prepare("SELECT urun.*,kategori.*,kullanici.* FROM urun INNER JOIN kategori ON urun.kategori_id=kategori.kategori_id INNER JOIN kullanici ON urun.kullanici_id=kullanici.kullanici_id WHERE urun_durum=:urun_durum and urun.urun_ad  like '%$searchkeyword%' or  urun.urun_detay like '%$searchkeyword%'");
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active clear products-container" id="list-view">
                                        <div class="product-list-view">
                                            <?php 
                                        if ($say==0) {
                                            echo "Bu  ürün Bulunamadı";
                                     }
   while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) {                     
 ?>
                                            <div class="single-item-list">
                                                <div class="item-img">
                                                    <img style="width: 237px;height: 162px;" src="<?php echo $uruncek['urunfoto_resimyol'] ?>" alt="product" class="img-responsive">
                                                ...
                                                <div class="item-content">
                                                    <div class="item-info">
                                                        ...
                                                        <div class="item-sale-info">
                                                            <div class="price"><?php echo $uruncek['urun_fiyat'] ?><span style="font-size: 14px;">TL</span></div>
                                                            <div class="sale-qty">satış ( 11 )</div>
                                                        </div>
                                                    </div>
                                                    <div class="item-profile">
                                                        <div class="profile-title">
                                                            <div class="img-wrapper"><img src="img\profile\1.jpg" alt="profile" class="img-responsive img-circle"></div>
                                                            <span><?php echo $uruncek['kullanici_ad']." ".mb_substr($uruncek['kullanici_soyad'],0,1) ?></span>
                                                        </div>
                                                                        ...
                                                                        <?php
                                                                                            ...
                                                                                            while ($s < $toplam_sayfa) {
                                                                                                ...
                                                                                                if (!empty($_GET['kategori_id'])) { 
                                                                                                    ...
                                                                                                    <li  style="background-color: #C84C3C; color:white;" ><a href="kategoriler-<?php echo $_GET['sef']; ?>-<?php echo $_GET['kategori_id'] ?>?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
