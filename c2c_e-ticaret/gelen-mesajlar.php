      ...
      <div class="settings-details tab-content">
        <div class="tab-pane fade active in" id="Personal">
          ...
          <div class="personal-info inner-page-padding"> 
            ...
            <tbody>
              <?php $urunsor=$db->prepare("SELECT mesaj.*,kullanici.* FROM mesaj inner join kullanici on mesaj.kullanici_gon=kullanici.kullanici_id where kullanici_gel=:id  order by mesaj_okunma,mesaj_zaman DESC");
         ...
         <?php         } else{ ?>
              ...
              <?php  } ?></td>
                  <td><center><a href="mesaj-detay?mesaj_id=<?php echo $uruncek['mesaj_id']; ?>"><button   class="btn  btn-primary btn-xs">oku</button></a></center></td>
               
                <td> <a onclick="return confirm('bu mesajı silmek istediğinizden emin misiniz? \nişlem geri alınamaz\ngonderenden de silinir')" href="nedmin/netting/kullanici.php?gelenmesajsil=ok&mesaj_id=<?php echo $uruncek['mesaj_id'] ?>"> <center><button class="btn btn-warning  btn-xs"> sil</button></center> </a></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
