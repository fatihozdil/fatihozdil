...
$urunsor=$db->prepare("SELECT mesaj.*,kullanici.* FROM mesaj inner join kullanici on mesaj.kullanici_gel=kullanici.kullanici_id where mesaj.kullanici_gon=:id and mesaj.mesaj_id=:mid  order by mesaj_zaman DESC");
