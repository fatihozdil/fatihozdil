            ...
            <tbody>
              ...
              while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)){$sira++ ?>
                <tr>
                  ...
                  <?php if ($uruncek['siparisdetay_onay']==0) { ?>
                 <td><center><a onclick="return confirm('are you sure?')" href="nedmin/netting/kullanici.php?siparisdd=<?php echo $uruncek['siparisdetay_id'] ?>&durum=okk"><button   class="btn  btn-warning btn-xs">onayla</button></a></center></td>
            
              <?php    } else if ($uruncek['siparisdetay_onay']==1) { ?>

                  <td><center><button   class="btn  btn-success btn-xs">Alıcıdan onay bekleniyor</button></center></td>
