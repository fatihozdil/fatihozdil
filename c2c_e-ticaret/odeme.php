                ...
                <div class="container">
                    ...
                    <tbody>
                        <tr>
                            <td data-th="Product">
                                <div class="row">
                                    <div style="width: 63px; height: 63px;" class="col-sm-2 hidden-xs"><img src="<?php echo $uruncek['urunfoto_resimyol'] ?>" alt="..." class="img-responsive"/></div>
                                    <div class="col-sm-10">
                                        <h4 class="nomargin"><?php echo $uruncek['urun_ad'] ?></h4>
                                        <p><?php echo mb_substr($uruncek['urun_detay'],0,150 ) ?></p>
                                    </div>
                                </div>
                            </td>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td><button onclick="geridön()" class="btn btn-warning"><i class="fa fa-angle-left"></i> Geridön</button></td>
                            ...
                            <td><button type="submit" name="sipariskaydet" class="btn btn-success btn-block">Siparişi Tamamla <i class="fa fa-angle-right"></i></button></td></form>
                        </tr>
                    </tfoot>
                </table>
                                </div>                                
